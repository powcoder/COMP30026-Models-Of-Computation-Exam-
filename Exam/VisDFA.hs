...
visDFANamed :: (Eq a, Innovative a, Show a, Ord a, PrintDot a)
  => String -> GDFA a -> IO ()
...
visNFANamed :: (Eq a, Innovative a, Show a, Ord a, PrintDot a)
  => String -> GNFA a -> IO ()
...
draw :: (Eq a, Innovative a, Show a, Ord a, PrintDot a)
  => String -> GNFA a -> IO FilePath
draw name nfa
...
nfaToDot :: (Eq a, Innovative a, Show a, Ord a, PrintDot a)
  => GNFA a -> DotGraph a
